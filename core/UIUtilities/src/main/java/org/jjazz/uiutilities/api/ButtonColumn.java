 ...
 * <p>
 * The button can be invoked by a mouse click or by pressing the space bar when the cell has focus. Optionaly a mnemonic can be set to invoke the button. When
