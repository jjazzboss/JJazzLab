 ...
 * .
 * The MixConsole Netbeans MenuBar is built from subfolders and actions
 * available in the Actions/MixConsole/MenuBar layer folder.
 */
@NbBundle.Messages(
        {
...
public class MixConsole extends JPanel implements PropertyChangeListener, ActionListener
{
     ...
     * @throws IllegalStateException If r is an AdaptedRhythm or if r does not
     * belong to this song
     */
...
//        menuEdit.setEnabled(true);
    ...
    /**
     * Update the UI used to adjust the visible rhythms (because songModel's
     * rhythms may have changed).
     */
