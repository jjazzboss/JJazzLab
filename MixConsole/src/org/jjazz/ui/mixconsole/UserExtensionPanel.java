...
public class UserExtensionPanel extends javax.swing.JPanel implements VetoableChangeListener, SgsChangeListener, PropertyChangeListener
{
     ...
     */
    public static final String PROP_RHYTHM_VOICE_CHANNEL = "PropRhythmVoiceChannel";
    ...
    {
        return midiMix.getChannel(userRhythmVoice);
    }
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        } else if (evt.getSource() == midiMix)
        {
            ...
            {
                int newChannel = (Integer) evt.getNewValue();
                int oldChannel = (Integer) evt.getOldValue();
                if (getChannel() == newChannel)     // getChannel() gets value from MidiMix so it's already changed
                {
                    firePropertyChange(PROP_RHYTHM_VOICE_CHANNEL, oldChannel, newChannel);
                }
            }
        }
    }
