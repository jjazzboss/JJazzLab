 ...
 * <p>
 * Because settings and drumsrerouting are interdependent, we can't have a simple dialog where data is retrieved only when dialog
 * is closed. Dialog must directly update and listen to the model changes.
 */
public class MixChannelPanelSettingsDialog extends javax.swing.JDialog implements PropertyChangeListener
{
    ...
    public void preset(MidiMix mm, int channel, String title)
    {
        ...
        } else
        {
            ...
            Utilities.setRecursiveEnabled(false, pnl_rerouting);
        }
    ...
    private void initComponents()
    {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(MixChannelPanelSettingsDialog.class, "MixChannelPanelSettingsDialog.title_1")); // NOI18N
