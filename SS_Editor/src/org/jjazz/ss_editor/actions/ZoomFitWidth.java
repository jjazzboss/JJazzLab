 ...
 */
@ActionID(category = "JJazz", id = "org.jjazz.ss_editor.actions.zoomfitwidth")
...
public class ZoomFitWidth extends AbstractAction
{
    ...
    public ZoomFitWidth()
    {
        ...
        putValue(SMALL_ICON, new ImageIcon(getClass().getResource("/org/jjazz/ss_editor/actions/resources/ZoomToFit.png")));
