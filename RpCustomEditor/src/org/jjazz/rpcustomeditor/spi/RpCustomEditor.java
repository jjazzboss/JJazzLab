 ...
 *  Contributor(s): 
 */
package org.jjazz.rpcustomeditor.spi;
 ...
 */
public abstract class RpCustomEditor<E> extends JPanel
{
    ...
    private RhythmParameter<E> rp;

    private static final Logger LOGGER = Logger.getLogger(RpCustomEditor.class.getSimpleName());

    public RpCustomEditor(RhythmParameter<E> rp)
    {
        if (rp == null)
        {
    ...
    final public RhythmParameter<E> getRhythmParameter()
    {
        return rp;
    }
