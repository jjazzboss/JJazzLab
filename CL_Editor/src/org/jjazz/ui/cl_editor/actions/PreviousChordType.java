...
@ActionID(category = "JJazz", id = "org.jjazz.ui.cl_editor.actions.previouschordtype")
@ActionRegistration(displayName = "#CTL_PreviousChordType")
@Messages("CTL_PreviousChordType=Previous chord type")
public final class PreviousChordType implements ActionListener
{

    private final List<CLI_ChordSymbol> context;
    private String undoText = CTL_PreviousChordType();

    public PreviousChordType(List<CLI_ChordSymbol> context)
    {
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        for (CLI_ChordSymbol item : context)
        {
            ...
            if (index >= 0)
            {
                int newIndex = (index == 0) ? ctd.getSize() - 1 : index - 1;
