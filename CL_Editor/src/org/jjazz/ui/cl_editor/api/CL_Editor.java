...
{
    // =====================================================================================================    
    // Editor public property names
    // =====================================================================================================    

    /**
     * OldValue=old nb of columns, newValue=new nb of columns
     */
     ...
     * <p>
     * When the corresponding propertyChangeEvent is fired, oldValue=old quantization, newValue=newQuantization.
     *
     * @param section
     * @return
     */
    static public String getSectionQuantizationPropertyName(Section section)
    {
        return "SectionDisplayQuantization" + "-" + section.getName() + "*" + section.getTimeSignature();
    }

    /**
     * Check if the property name corresponds to a name generated by getSectionQuantizationPropertyName().
     *
     * @param propName
     * @return
     * @see #getSectionQuantizationPropertyName(org.jjazz.leadsheet.chordleadsheet.api.Section)
     */
    static public boolean isSectionQuantizationPropertyName(String propName)
    {
        return propName.startsWith("SectionDisplayQuantization-");
    }

    /**
     * Get the Section-color property name for the specified section.
     * <p>
     * When the corresponding propertyChangeEvent is fired, oldValue=old color, newValue=new color.
     *
     * @param section
     * @return
     */
    static public String getSectionColorPropertyName(Section section)
    {
        return "SectionColor" + "-" + section.getName();
    }

    /**
     * Check if the property name corresponds to a name generated by getSectionColorPropertyName().
     *
     * @param propName
     * @return
     * @see #getSectionColorPropertyName(org.jjazz.leadsheet.chordleadsheet.api.Section)
     */
    static public boolean isSectionColorPropertyName(String propName)
    {
        return propName.startsWith("SectionColor-");
    }

    /**
     * Get the Section-starts-on-new-line property name for the specified section.
     * <p>
     * When the corresponding propertyChangeEvent is fired, oldValue=oldIsStartingOnNewLine, newValue=newIsStartingOnNewLine.
     *
     * @param section
     * @return
     */
    static public String getSectionOnNewLinePropertyName(Section section)
    {
        return "SectionStartOnNewLine" + "-" + section.getName();
    }

    /**
     * Check if the property name corresponds to a name generated by getSectionOnNewLinePropertyName().
     *
     * @param propName
     * @return
     * @see #getSectionOnNewLinePropertyName(org.jjazz.leadsheet.chordleadsheet.api.Section)
     */
    static public boolean isSectionOnNewLinePropertyName(String propName)
    {
        return propName.startsWith("SectionStartOnNewLine-");
    }

    /**
     * Retrieve the section name from one of the section-generated property names.
     *
     * @param propName
     * @return
     * @see #getSectionColorPropertyName(org.jjazz.leadsheet.chordleadsheet.api.Section)
     ...
     * @see #getSectionQuantizationPropertyName(org.jjazz.leadsheet.chordleadsheet.api.Section)
     */
    static public String getSectionNameFromPropertyName(String propName)
    {
        int indexFrom = propName.indexOf("-") + 1;
        assert indexFrom > 0 : "propName=" + propName;
        int indexTo = propName.indexOf("*");
        if (indexTo == -1)
        {
            indexTo = propName.length();
        }
        assert indexTo > indexFrom : "propName=" + propName;
        String name = propName.substring(indexFrom, indexTo);
        return name;
    }
