...
import org.jjazz.ui.cl_editor.actions.NextChordType;
...
import org.jjazz.ui.cl_editor.actions.PreviousChordType;
...
public class CL_EditorController implements CL_EditorMouseListener
{
    ...
    public CL_EditorController(CL_Editor ed)
    {
        ...
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("control DOWN"), "TransposeDown");
        editor.getActionMap().put("TransposeDown", transposeDownAction);
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("control UP"), "TransposeUp");
        ...
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("control LEFT"), "MoveItemLeft");
        editor.getActionMap().put("MoveItemLeft", Actions.forID("JJazz", "org.jjazz.ui.cl_editor.actions.moveitemleft"));
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("control RIGHT"), "MoveItemRight");
        editor.getActionMap().put("MoveItemRight", Actions.forID("JJazz", "org.jjazz.ui.cl_editor.actions.moveitemright"));
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("shift UP"), "NextChordType");
        editor.getActionMap().put("NextChordType", Actions.forID("JJazz", "org.jjazz.ui.cl_editor.actions.nextchordtype"));
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("shift DOWN"), "PreviousChordType");
        editor.getActionMap().put("PreviousChordType", Actions.forID("JJazz", "org.jjazz.ui.cl_editor.actions.previouschordtype"));
        editor.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke("control E"), "SetEndBar");
