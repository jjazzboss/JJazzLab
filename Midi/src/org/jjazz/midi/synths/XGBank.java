...
public class XGBank extends AbstractInstrumentBank<Instrument>
{
    ...
    private XGBank()
    {
        ...
        addInstrument(createInstrument("GrandPiano KSP", 0, 1, 0));
        ...
        addInstrument(createInstrument("BrightPiano KSP", 0, 1, 1));
        addInstrument(createInstrument("El.GrandPiano", 0, 0, 2));
        addInstrument(createInstrument("El.GrandPiano KSP", 0, 1, 2));
        ...
        addInstrument(createInstrument("Honkytonk KSP", 0, 1, 3));
        addInstrument(createInstrument("ElectricPiano1", 0, 0, 4));
        addInstrument(createInstrument("ElectricPiano1 KSP", 0, 1, 4));
        ...
        addInstrument(createInstrument("ElectricPiano2 KSP", 0, 1, 5));
        ...
        addInstrument(createInstrument("Harpsichord KSP", 0, 1, 6));
        ...
        addInstrument(createInstrument("Clavi KSP", 0, 1, 7));
        ...
        addInstrument(createInstrument("Vibraphone KSP", 0, 1, 11));
        addInstrument(createInstrument("HardVibes", 0, 45, 11));
        addInstrument(createInstrument("Marimba", 0, 0, 12));
        addInstrument(createInstrument("Marimba KSP", 0, 1, 12));
        ...
        DEFAULT_DRUMS_INSTRUMENT = createDrumsInstrument("Std1 Kit", 127, 0, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance());
        addInstrument(DEFAULT_DRUMS_INSTRUMENT);
        addInstrument(createDrumsInstrument("Std2 Kit", 127, 1, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Dry Kit", 127, 2, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Bright Kit", 127, 3, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Skim Kit", 127, 4, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Slim Kit", 127, 5, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Rogue Kit", 127, 6, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Hob Kit", 127, 7, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Room Kit", 127, 8, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Dark Kit", 127, 9, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Rock_Old Kit", 127, 16, DrumKit.Type.POWER, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Rock_Old2 Kit", 127, 17, DrumKit.Type.POWER, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Electro Kit", 127, 24, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Analog Kit", 127, 25, DrumKit.Type.ANALOG, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Analog2 Kit", 127, 26, DrumKit.Type.ANALOG, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Dance Kit", 127, 27, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Hiphop Kit", 127, 28, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Jungle Kit", 127, 29, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Apogee Kit", 127, 30, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Perigee Kit", 127, 31, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Jazz Kit", 127, 32, DrumKit.Type.JAZZ, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Jazz2 Kit", 127, 33, DrumKit.Type.JAZZ, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Brush Kit", 127, 40, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Real_Brush Kit", 127, 41, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Symphony Kit", 127, 48, DrumKit.Type.ORCHESTRA, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("HipHop2 Kit", 127, 56, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Break Kit", 127, 57, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Tramp Kit", 127, 64, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Amber Kit", 127, 65, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Coffin Kit", 127, 66, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Live_Std Kit", 127, 80, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Live_Funk Kit", 127, 81, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Live_Brush Kit", 127, 82, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Live_Std_Perc Kit", 127, 83, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Live_Funk_Perc Kit", 127, 84, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Live_Brush_Perc Kit", 127, 85, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SFX1 Kit", 126, 0, DrumKit.Type.SFX, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SFX2 Kit", 126, 1, DrumKit.Type.SFX, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Techno_KS Kit", 126, 16, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Techno_HI Kit", 126, 17, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Techno_LO Kit", 126, 18, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Sakura Kit", 126, 32, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("Small_Latin Kit", 126, 33, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("China Kit", 126, 34, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
