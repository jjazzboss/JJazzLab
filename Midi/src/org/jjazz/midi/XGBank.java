...
public class XGBank extends AbstractInstrumentBank<Instrument>
{
    ...
    private XGBank()
    {
        ...
        DEFAULT_DRUMS_INSTRUMENT = createDrumsInstrument("STD1", 127, 0, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance());
        addInstrument(DEFAULT_DRUMS_INSTRUMENT);
        addInstrument(createDrumsInstrument("STD2", 127, 1, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("DRY", 127, 2, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("BRIGHT", 127, 3, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SKIM", 127, 4, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SLIM", 127, 5, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ROGUE", 127, 6, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("HOB", 127, 7, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ROOM", 127, 8, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("DARK", 127, 9, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ROCK_OLD", 127, 16, DrumKit.Type.POWER, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ROCK_OLD2", 127, 17, DrumKit.Type.POWER, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ELECTRO", 127, 24, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ANALOG", 127, 25, DrumKit.Type.ANALOG, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("ANALOG2", 127, 26, DrumKit.Type.ANALOG, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("DANCE", 127, 27, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("HIPHOP", 127, 28, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("JUNGLE", 127, 29, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("APOGEE", 127, 30, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("PERIGEE", 127, 31, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("JAZZ", 127, 32, DrumKit.Type.JAZZ, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("JAZZ2", 127, 33, DrumKit.Type.JAZZ, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("BRUSH", 127, 40, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("REAL_BRUSH", 127, 41, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SYMPHONY", 127, 48, DrumKit.Type.ORCHESTRA, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("HIPHOP2", 127, 56, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("BREAK", 127, 57, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("TRAMP", 127, 64, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("AMBER", 127, 65, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("COFFIN", 127, 66, DrumKit.Type.ROOM, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("LIVE_STD", 127, 80, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("LIVE_FUNK", 127, 81, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("LIVE_BRUSH", 127, 82, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("LIVE_STD_PERC", 127, 83, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("LIVE_FUNK_PERC", 127, 84, DrumKit.Type.STANDARD, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("LIVE_BRUSH_PERC", 127, 85, DrumKit.Type.BRUSH, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SFX1", 126, 0, DrumKit.Type.SFX, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("SFX2", 126, 1, DrumKit.Type.SFX, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("TECHNO_KS", 126, 16, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("TECHNO_HI", 126, 17, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
        addInstrument(createDrumsInstrument("TECHNO_LO", 126, 18, DrumKit.Type.ELECTRONIC, KeyMapXG_Std.getInstance()));
