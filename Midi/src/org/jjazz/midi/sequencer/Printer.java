...
final class Printer
{
    ...
    /**
     * This method is used in the special cases which "should never happen...". And in fact if should be implemented as an
     * assertion, but for compatibility reason it just print an error only in case of "internal" build. In time its usage should
     * be replaced by some kind of assertion or dropped completly.
     */
