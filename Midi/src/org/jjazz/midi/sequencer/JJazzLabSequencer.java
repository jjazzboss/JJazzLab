...
final class JJazzLabSequencer extends AbstractMidiDevice implements Sequencer, AutoConnectSequencer
{
     ...
     */
    static final MidiDevice.Info info = new JJazzLabSequencerInfo();
    ...
    {
        super(info);
        LOGGER.info("JJazzLabSequencer() Setting up JJazzLab sequencer");
    }
    ...
    protected synchronized void implClose()
    {
        ...
        /**
         * if this sequencer is set to autoconnect, need to re-establish the connection at next open!
         */
    ...
    private static class JJazzLabSequencerInfo extends MidiDevice.Info
    {

        private static final String name = "JJazzLab Real Time Sequencer";
        private static final String vendor = "JJazzLab";
        private static final String description = "Software sequencer";
        private static final String version = "Version 1.0";

        JJazzLabSequencerInfo()
        {
    ...
    final class PlayThread implements Runnable
    {
         ...
         * <p>
         * Make sure to NOT synchronize on RealTimeSequencer anywhere here (even implicit). That is a sure deadlock!
         */
        @Override
        public void run()
        {
    ...
    private class DataPump
    {
        ...
        private boolean[] makeDisabledArray()
        {
            ...
            boolean[] solo;
            boolean[] mute;
            synchronized (JJazzLabSequencer.this)
            {
                mute = trackMuted;
                solo = trackSolo;
            }
