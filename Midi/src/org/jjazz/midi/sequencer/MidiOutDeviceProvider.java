...
public final class MidiOutDeviceProvider extends AbstractMidiDeviceProvider
{
    ...
    /**
     * Info class for MidiOutDevices. Adds the provider's Class to keep the provider class from being unloaded. Otherwise, at
     * least on JDK1.1.7 and 1.1.8, the provider class can be unloaded. Then, then the provider is next invoked, the static block
     * is executed again and a new instance of the device object is created. Even though the previous instance may still exist and
     * be open / in use / etc., the new instance will not reflect that state...
     */
