 ...
 */
@ActionID(category = "JJazz", id = "org.jjazz.cl_editor.actions.accentdefault")
...
public final class AccentDefault extends AbstractAction implements ContextAwareAction, CL_ContextActionListener, Presenter.Popup, ClsChangeListener
{
    ...
    private final String undoText = ResUtil.getString(getClass(), "CTL_AccentDefault");
    private ChordLeadSheet currentCls;
    private static final Logger LOGGER = Logger.getLogger(AccentDefault.class.getSimpleName());

    public AccentDefault()
    {
        this(Utilities.actionsGlobalContext());
    }

    public AccentDefault(Lookup context)
    {
    ...
    {
        return new AccentDefault(context);
    }
