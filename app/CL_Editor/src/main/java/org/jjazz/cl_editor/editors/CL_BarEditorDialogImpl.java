 ...
 *  Contributor(s): 
 */
package org.jjazz.cl_editor.editors;
...
public class CL_BarEditorDialogImpl extends CL_BarEditorDialog
{
    ...
    private void actionOK()
    {
        ...
        if (isChordsChanged)
        {
            ...
            try
            {
                newItems = CLI_ChordSymbol.toCLI_ChordSymbolsNoPosition(strChords, barIndex, model, swing);
    ...
    private void initComponents()
    {
        ...
        fbtn_expand.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/jjazz/cl_editor/editors/resources/arrow_collapsed.png"))); // NOI18N
        fbtn_expand.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/org/jjazz/cl_editor/editors/resources/arrow_expanded.png"))); // NOI18N
