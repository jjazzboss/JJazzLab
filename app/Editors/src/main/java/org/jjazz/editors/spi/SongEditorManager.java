...
import org.jjazz.editors.api.SongEditorTopComponent;
...
public interface SongEditorManager
{
     ...
     *
     * @return Can be null if running in headless environment
     */
     ...
     * @return Can be null.
     */
    Set<SongEditorTopComponent> getSongEditorSet(Song s);
    ...
    public class SongEditorSet
    {
        ...
        protected SongEditorSet(CL_EditorTopComponent tcCle, SS_EditorTopComponent tcSse)
        {
