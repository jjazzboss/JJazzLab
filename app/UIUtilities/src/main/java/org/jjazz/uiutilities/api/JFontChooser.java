...
/**
 * The <code>JFontChooser</code> class is a swing component for font selection. This class has <code>JFileChooser</code> like
...
public class JFontChooser extends JComponent
{
     ...
     *
     * @param style the size of the selected font. <code>Font.PLAIN</code>, <code>Font.BOLD</code>, <code>Font.ITALIC</code>, or
     * <code>Font.BOLD|Font.ITALIC</code>.
     *
     * @see java.awt.Font#PLAIN
     * @see java.awt.Font#BOLD
    ...
    protected JTextField getSampleTextField()
    {
        if (sampleText == null)
        {
            ...
            sampleText = new JTextField(("Cm7 F6 A7M"));
