...
final class MidiInPanel extends javax.swing.JPanel implements ListSelectionListener
{
    ...
    void load()
    {
        ...
        remoteActions.sort((ra1, ra2) -> 
        {
            // Sort by note pitch when possible
            int p1 = ra1.getControlNotePitch() == -1 ? 1000 : ra1.getControlNotePitch();
            int p2 = ra2.getControlNotePitch() == -1 ? 1000 : ra2.getControlNotePitch();
            int res = Integer.compare(p1, p2);
            return res;
        });
        list_actions.setListData(remoteActions.toArray(RemoteAction[]::new));
        list_actions.addListSelectionListener(this);
    ...
    private class RemoteActionRenderer extends DefaultListCellRenderer
    {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus)
        {
            ...
            label.setText(txt);
            label.setToolTipText((String) ra.getAction().getValue(Action.SHORT_DESCRIPTION));
            return label;
        }
    }
