    ...
    private List<Reverb> loadReverbPresets()
    {
        ...
        if (s != null)
        {
            ...
            for (var str : strs)
            {
                ...
                {
                    LOGGER.log(Level.WARNING, "loadRevPresets() Invalid Reverb string, ignoring str={0}. ex={1}", new Object[]{str,
                        ex.getMessage()});
                }
            }
        }
    ...
    private List<Chorus> loadChorusPresets()
    {
        ...
        if (s != null)
        {
            ...
            for (var str : strs)
            {
                ...
                {
                    LOGGER.log(Level.WARNING, "loadChoPresets() Invalid Chorus string, ignoring str={0}. ex={1}", new Object[]{str,
                        ex.getMessage()});
                }
            }
        }
