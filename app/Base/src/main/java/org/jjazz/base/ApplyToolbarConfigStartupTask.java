 ...
 */
@OnShowing
public class ApplyToolbarConfigStartupTask implements Runnable
{

    private static final Logger LOGGER = Logger.getLogger(ApplyToolbarConfigStartupTask.class.getSimpleName());
