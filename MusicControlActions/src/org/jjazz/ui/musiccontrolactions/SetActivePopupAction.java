 ...
 */
@ActionID(category = "MusicControls", id = "org.jjazz.ui.musiccontrolactions.setactivepopupaction")
...
public class SetActivePopupAction implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        clTc.requestActive();
        Action a = Actions.forID("MusicControls", "org.jjazz.ui.musiccontrolactions.setactive");
