 ...
 *  Contributor(s): 
 */
package org.jjazz.midisynth.api;
...
import static org.jjazz.midisynth.api.Bundle.ERR_NoBuiltinMidiSynthFiles;
...
/**
 * A class to maintain the list of active MidiSynths for the application.
 * <p>
 * By default contains the GMSynth and all the builtin synths of the MidiSynthProvider instances found in the global lookup. User
 * can add MidiSynths. The list of user added synths is saved as properties.
 */
@NbBundle.Messages(
        {
            "ERR_NoBuiltinMidiSynthFiles=No builtin Midi synth files found"
        })
public class MidiSynthManager
{
    ...
    private void updateGM1Bank(InstrumentBank<?> bank)
    {
        ...
        gm1bank.setBankSelectLsb(bank == null ? GM1Bank.DEFAULT_BANK_SELECT_LSB : bank.getBankSelectLSB());
        gm1bank.setBankSelectMsb(bank == null ? GM1Bank.DEFAULT_BANK_SELECT_MSB : bank.getBankSelectMSB());
