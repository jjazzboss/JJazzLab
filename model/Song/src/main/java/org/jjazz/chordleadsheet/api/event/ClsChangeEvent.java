...
public abstract class ClsChangeEvent
{
    ...
    protected final List<PropertyChangeEvent> itemChanges;
    ...
    /**
     * Add some ChordLeadSheetItem change events generated by this change.
     * 
     * @param changes PropertyChangeEvents must be adapted to this event's undo/redo state.
     */
    public void addItemChanges(List<PropertyChangeEvent> changes)
    {
        itemChanges.addAll(changes);
    }

    /**
     * Get all the ChordLeadSheetItem change events generated by this change.
     * 
     * @return Can be empty. Returned PropertyChangeEvents are adapted to the undo/redo state, i.e caller does not need to reverse oldValue/newValue if isUndo() is true.
     */
    public List<PropertyChangeEvent> getItemChanges()
    {
        return itemChanges;
    }

    /**
     * Get the ChordLeadSheetItem change events which match propertyName.
     *
     * @param propertyName
     * @return Can be empty
     */
    public List<PropertyChangeEvent> getItemChanges(String propertyName)
    {
        return itemChanges.stream()
                .filter(evt -> evt.getPropertyName().equals(propertyName))
                .toList();
    }
