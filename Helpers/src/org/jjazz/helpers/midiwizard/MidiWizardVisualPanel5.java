...
public final class MidiWizardVisualPanel5 extends JPanel
{
    ...
    {//GEN-HEADEREND:event_btn_test1ActionPerformed
        sendTestNotes(1, 2, GMSynth.getInstance().getGM1Bank().getDefaultInstrument(Family.Organ), 0);
    ...
    {//GEN-HEADEREND:event_btn_test2ActionPerformed
        sendTestNotes(1, 11, GMSynth.getInstance().getGM1Bank().getDefaultInstrument(Family.Reed), -12);
    ...
    {//GEN-HEADEREND:event_btn_testDrumsOtherChannelGM2ActionPerformed
        sendTestNotes(2, 2, GM2Synth.getInstance().getGM2Bank().getDefaultDrumsInstrument(), -12);
    ...
    {//GEN-HEADEREND:event_btn_testDrumsOtherChannelXGActionPerformed
        sendTestNotes(3, 3, XGSynth.getInstance().getXGBank().getDefaultDrumsInstrument(), -12);
