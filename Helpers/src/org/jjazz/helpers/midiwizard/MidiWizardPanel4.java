...
public class MidiWizardPanel4 implements WizardDescriptor.Panel<WizardDescriptor>
{
     ...
     * getComponent().
     */
    private MidiWizardVisualPanel4 component;
    ...
    @Override
    public MidiWizardVisualPanel4 getComponent()
    {
        if (component == null)
        {
            component = new MidiWizardVisualPanel4();
        }
        return component;
    }
